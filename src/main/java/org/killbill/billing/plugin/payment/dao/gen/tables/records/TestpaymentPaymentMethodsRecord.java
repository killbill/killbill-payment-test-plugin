...
public class TestpaymentPaymentMethodsRecord extends UpdatableRecordImpl<TestpaymentPaymentMethodsRecord> implements Record8<ULong, String, String, Short, String, Timestamp, Timestamp, String> {

    private static final long serialVersionUID = -782708394;
     ...
     */
    @Override
    public TestpaymentPaymentMethodsRecord values(ULong value1, String value2, String value3, Short value4, String value5, Timestamp value6, Timestamp value7, String value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TestpaymentPaymentMethodsRecord(ULong recordId, String kbAccountId, String kbPaymentMethodId, Short isDeleted, String additionalData, Timestamp createdDate, Timestamp updatedDate, String kbTenantId) {
        super(TestpaymentPaymentMethods.TESTPAYMENT_PAYMENT_METHODS);
