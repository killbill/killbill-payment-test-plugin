...
public class TestpaymentResponses extends TableImpl<TestpaymentResponsesRecord> {
    ...
    private static final long serialVersionUID = -653038718;
     ...
     */
    public final TableField<TestpaymentResponsesRecord, ULong> RECORD_ID = createField("record_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>killbill.testpayment_responses.status</code>.
     */
    public final TableField<TestpaymentResponsesRecord, String> STATUS = createField("status", org.jooq.impl.SQLDataType.CHAR.length(10).nullable(false), this, "");

    /**
     * The column <code>killbill.testpayment_responses.kb_account_id</code>.
     */
    public final TableField<TestpaymentResponsesRecord, String> KB_ACCOUNT_ID = createField("kb_account_id", org.jooq.impl.SQLDataType.CHAR.length(36).nullable(false), this, "");

    /**
     * The column <code>killbill.testpayment_responses.kb_payment_id</code>.
     */
    public final TableField<TestpaymentResponsesRecord, String> KB_PAYMENT_ID = createField("kb_payment_id", org.jooq.impl.SQLDataType.CHAR.length(36).nullable(false), this, "");

    /**
     * The column <code>killbill.testpayment_responses.kb_payment_transaction_id</code>.
     */
    public final TableField<TestpaymentResponsesRecord, String> KB_PAYMENT_TRANSACTION_ID = createField("kb_payment_transaction_id", org.jooq.impl.SQLDataType.CHAR.length(36).nullable(false), this, "");

    /**
     * The column <code>killbill.testpayment_responses.transaction_type</code>.
     */
    public final TableField<TestpaymentResponsesRecord, String> TRANSACTION_TYPE = createField("transaction_type", org.jooq.impl.SQLDataType.VARCHAR.length(32).nullable(false), this, "");

    /**
     * The column <code>killbill.testpayment_responses.amount</code>.
     */
    public final TableField<TestpaymentResponsesRecord, BigDecimal> AMOUNT = createField("amount", org.jooq.impl.SQLDataType.DECIMAL.precision(15, 9), this, "");

    /**
     * The column <code>killbill.testpayment_responses.currency</code>.
     */
    public final TableField<TestpaymentResponsesRecord, String> CURRENCY = createField("currency", org.jooq.impl.SQLDataType.CHAR.length(3), this, "");

    /**
     * The column <code>killbill.testpayment_responses.additional_data</code>.
     */
    public final TableField<TestpaymentResponsesRecord, String> ADDITIONAL_DATA = createField("additional_data", org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * The column <code>killbill.testpayment_responses.created_date</code>.
     */
    public final TableField<TestpaymentResponsesRecord, Timestamp> CREATED_DATE = createField("created_date", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false), this, "");

    /**
     * The column <code>killbill.testpayment_responses.kb_tenant_id</code>.
     */
    public final TableField<TestpaymentResponsesRecord, String> KB_TENANT_ID = createField("kb_tenant_id", org.jooq.impl.SQLDataType.CHAR.length(36).nullable(false), this, "");
